...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a data-modal="modal-13" id="rest"><i class="fas fa-shopping-cart"></i>&nbsp; Lista de Compras</a>
        </li>
    </ul>
</div>
...
<!-- modal Compras -->
<div class="md-modal md-effect-14" id="modal-13">
    <div class="md-content">
        <h3>Compra de Inventario</h3>
        <div>
            <table class="table table-bordered" width="100%" cellspacing="0" id="tablaCompras">
                <thead style="background-color: rgba(11, 23, 41 , 0.6);">
                <th>Producto</th>
                <th>Fecha</th>
                <th>Cantidad</th>
